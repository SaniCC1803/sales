  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl max-h-[90vh] p-0">
        ...
        <div className="flex items-center justify-center relative p-4 pt-2" style={{ height: '60vh' }}>
          <img
            ...
            {images.map((img, idx) => (
              <button
                ...
                className={`flex-shrink-0 w-20 h-16 rounded border-2 overflow-hidden transition-all ${
                  idx === currentIndex ? 'border-primary ring-2 ring-primary/20' : 'border-muted hover:border-border'
                }`}
